...
def get_financial_data():
    ...
    try:
        ...
        data = {
            ...
            "annualReport2023": {
                "revenue": safe_format(revenue / 1e8 if revenue is not None else None),
                "revenue_yoy": safe_format(revenue_yoy),
                "net_profit": safe_format(net_profit / 1e8 if net_profit is not None else None),
